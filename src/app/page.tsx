      ...
      <section id="stock" className={styles.section}>
        <div className={styles.sectionInner}>
              ...
              <article key={m.id} className={styles.machineCard}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardFooter}>
                    ...
                    <a
                      href={`https://wa.me/254700000000?text=Hi%2C+I%27m+interested+in+the+${encodeURIComponent(m.name)}`}
                      target="_blank"
          ...
          <div className={styles.stockFooter}>
            ...
            <a
              href="https://wa.me/254700000000?text=Hi%2C+I%27m+looking+for+a+specific+machine"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className={styles.formRight}>
              {submitted ? (
                <div className={styles.formSuccess}>
                  ...
                  <a href="https://wa.me/254700000000?text=Hi%2C+I+just+submitted+a+match+request" target="_blank" rel="noopener noreferrer" className={styles.ctaPrimary}>
                    Open WhatsApp Chat
                  </a>
                </div>
              ) : (
        ...
        <div className={styles.sectionInner}>
          <div className={styles.finalCtaInner}>
            ...
            <div className={styles.finalCtaButtons}>
              ...
              <a href="https://wa.me/254700000000?text=Hi%2C+I+need+a+machine+urgently" target="_blank" rel="noopener noreferrer" className={styles.ctaWhatsAppFull}>
