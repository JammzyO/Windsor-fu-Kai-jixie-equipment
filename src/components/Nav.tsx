...
export default function Nav() {
  ...
  // Allow other parts of the page to trigger the modal via custom event
  useEffect(() => {
    ...
    <header className={`${styles.nav} ${scrolled ? styles.scrolled : ""}`}>
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          <button
            ...
            aria-label="Find your machine via WhatsApp"
          >
          ...
          <a href="#book" className={styles.bookCta}>
            Book a Call
          </a>
      ...
      {menuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <a href="#verify" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>Verification</a>
